...
! function (t, i) {
    ...
    return J.prototype.destroy = function () {
                ...
                if (this._events.flick && n < this.options.flickLimitTime && r < this.options.flickLimitDistance && h < this.options.flickLimitDistance) this.trigger("flick");
                    ...
                    if (this.options.momentum && n < this.options.momentumLimitTime && (h > this.options.momentumLimitDistance || r > this.options.momentumLimitDistance)) {
                        ...
                        var m = -1 === this.directionX && p || 1 === this.directionX && d ? this.wrapperWidth : 0,
                            ...
                            g = this.hasHorizontalScroll ? H(this.x, this.startX, n, this.maxScrollX, this.minScrollX, m, this.options) : {
                                destination: i,
                                duration: 0
                            },
                            v = this.hasVerticalScroll ? H(this.y, this.startY, n, this.maxScrollY, this.minScrollY, f, this.options) : {
                                destination: e,
                                duration: 0
                            };
        ...
        if (h && this.lastClickTime) {
            var l = h.delay,
                c = void 0 === l ? 300 : l;
            w() - this.lastClickTime < c && (a = !0, P(t, "dblclick"))
        }
        ...
        var c = this,
            ...
            f = w(),
            g = f + a;
        this.isAnimating = !0, W(this.animateTimer),
            function t() {
                var i = w();
        ...
        var e = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : 0,
            s = 3 < arguments.length && void 0 !== arguments[3] ? arguments[3] : I.bounce;
        this.isInTransition = this.options.useTransition && 0 < e && (t !== this.x || i !== this.y), !e || this.options.useTransition ? (this._transitionTimingFunction(s.style), this._transitionTime(e), this._translate(t, i), e && 3 === this.options.probeType && this._startProbe(), e || t === this.x && i === this.y || (this.trigger("scroll", {
            x: t,
            y: i
        ...
        "string" == typeof g && (g = this.scroller.querySelectorAll(g)), this.on("refresh", function () {
            ...
            if (f.loop) {
                ...
                2 < t.length && (E(m.scroller, t[t.length - 1]), E(m.scroller, t[0]))
            }
        })
        ...
        var i = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : 0,
            ...
            s = arguments[3],
            o = this.options.snap;
        if (o && this.pages && this.pages.length && (s = s || o.easing || I.bounce, t >= this.pages.length ? t = this.pages.length - 1 : t < 0 && (t = 0), this.pages[t])) {
